...
public class Enemy : MonoBehaviour
{
    ...
    private NavMeshHit navMeshHit; public float wanderRange;
    public Animator zombie_death;
    ...
    void Update()
    {
        ...
        {
            pos = wayPoints[currentRoot];//Vector3型のposに現在の目的地の座標を代入
        }
        ...
        {//Modeの切り替えは
            ...
            case 2://case1の場合
                agent.destination = enemypos.transform.position;//動きを停止する		
                break;//switch文の各パターンの最後につける
        }
